...
const Navbar = ({
  ...
  // console.log(cart, addToCart, removeFromCart, clearToCart, subTotal)
  ...
  return (
    <>
      ...
      <div
        className={`flex flex-col md:flex-row md:justify-start justify-center items-center1 py-2 shadow-md sticky top-0 bg-white z-10 ${
